...
#   ggplot(aes(Segment, `Total Quantity Purchased`, fill = ifelse(`Total Quantity Purchased` == max(`Total Quantity Purchased`), "Highlighted", "Normal"))) +
#   geom_col(show.legend = FALSE) +
#   scale_fill_manual(values = c("#0072b2", "#999999")) +
#   geom_text(aes(label = `Total Quantity Purchased`), vjust = -0.5) +
...
#   ggplot(aes(Segment, `Total of Expenses`, fill = ifelse(`Total of Expenses` == max(`Total of Expenses`), "Highlighted", "Normal"))) +
#   geom_col(show.legend = FALSE) +
#   scale_fill_manual(values = c("#0072b2", "#999999")) +
#   geom_text(aes(label = `Total of Expenses`), vjust = -0.5) +
#   scale_x_continuous(breaks = 1:6) + 
#   labs(x = NULL,
#        y = NULL, 
#        title = NULL) + 
